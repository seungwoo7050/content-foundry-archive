...
```json
{
  ...
  "bundleChecksum": "sha256:45a1c3f057fb59b3a7fd28e5e87a8c41eb299d0446c71949e5d4e32d2a92d745"
}
```
...
Contract `3.0.0` uses a closed 13-discriminator block vocabulary:
...
```json
{
  ...
  "status": "succeeded",
  "routeCount": 5,
  "deployedAt": "2026-08-24T03:08:00Z",
