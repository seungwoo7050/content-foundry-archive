...
Yes for each frozen baseline retained in Git history, with one explicit
interpretation rule: the canonical shared contract package selected by a
release is normative for the ContentOps ↔ Public Sites boundary.
