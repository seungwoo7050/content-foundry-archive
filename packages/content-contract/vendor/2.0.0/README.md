...
`2.0.0` completes the machine-readable release bundle used for Public Sites
Phase 0. The frozen `1.0.0` baseline remains available in Git history for old
immutable releases.
