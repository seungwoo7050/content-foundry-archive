...
Contract `4.0.0` carries that complete union forward unchanged.
...
A consumer declaring `3.0.0` or `4.0.0` support accepts every released branch
and rejects unknown discriminators. A subset renderer is not a compatible v3
or v4 consumer. Version dispatch, producer adoption, and rollback follow
