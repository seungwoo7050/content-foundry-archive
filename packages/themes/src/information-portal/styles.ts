...
.ip-nav-row{display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:.5rem 1rem;padding:0 1rem .7rem}.ip-nav-wide{display:none;min-width:0}.ip-menu{min-width:0;flex:1 1 12rem}.ip-menu>summary{display:flex;min-height:44px;align-items:center;justify-content:center;padding:.45rem .75rem;border:1px solid var(--color-border);background:var(--color-surface-muted);color:var(--color-primary);font-weight:800;cursor:pointer}.ip-menu[open]{flex-basis:100%}.ip-menu[open]>.ip-nav-mobile{margin-top:.5rem}.ip-nav-row ul{display:flex;flex-wrap:wrap;gap:.25rem;margin:0;padding:0;list-style:none}.ip-nav-row ul ul{margin-left:.5rem}.ip-nav-row a,.ip-action{display:inline-flex;min-height:44px;align-items:center;padding:.45rem .75rem;border:1px solid var(--color-border);background:var(--color-surface-muted);font-weight:700;text-decoration:none}.ip-nav-row .ip-masthead-search{border-color:var(--color-primary);background:var(--color-primary);color:var(--color-on-primary)!important}
...
.ip section[aria-labelledby="ip-reader-actions"]{display:grid;gap:.75rem;border-top:3px solid var(--color-primary)}.ip section[aria-labelledby="ip-reader-actions"]>h2{margin:0;font-size:1.1rem}.ip section[aria-labelledby="ip-reader-actions"]>section{display:grid;gap:.65rem}.ip section[aria-labelledby="ip-reader-actions"] :is(.article-bookmark,.article-share-action,.article-feedback){min-width:0;margin:0;padding:.75rem;background:var(--color-surface-muted);border:1px solid var(--color-border)}.ip section[aria-labelledby="ip-reader-actions"] :is(.article-bookmark,.article-share-action){display:flex;flex-wrap:wrap;align-items:center;gap:.5rem .75rem}.ip section[aria-labelledby="ip-reader-actions"] .article-feedback{display:grid;gap:.6rem}.ip section[aria-labelledby="ip-reader-actions"] .article-feedback h2{margin:0;font-size:1rem}.ip section[aria-labelledby="ip-reader-actions"] .article-feedback [role="group"]{display:flex;flex-wrap:wrap;gap:.5rem}.ip section[aria-labelledby="ip-reader-actions"] button{display:inline-flex;min-height:44px;align-items:center;justify-content:center;padding:.55rem .85rem;color:var(--color-text);background:var(--color-surface);border:1px solid var(--color-primary);font:inherit;font-weight:750;cursor:pointer}.ip section[aria-labelledby="ip-reader-actions"] button:focus-visible{outline:3px solid var(--focus-ring);outline-offset:2px}.ip section[aria-labelledby="ip-reader-actions"] button[aria-pressed="true"]{color:var(--color-on-primary);background:var(--color-primary)}.ip section[aria-labelledby="ip-reader-actions"] button:disabled{cursor:not-allowed;opacity:.58}.ip section[aria-labelledby="ip-reader-actions"] :is([role="status"],[aria-live="polite"]){display:block;min-width:0;min-height:1.5em;margin:0;overflow-wrap:anywhere;color:var(--color-text-muted);font-size:.78rem}
.ip .search-controller{min-width:0}
.ip .search-controller form{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:end;gap:.55rem}
.ip .search-controller label{grid-column:1/-1;font-size:.85rem;font-weight:800}
.ip .search-controller input{min-width:0;min-height:48px;padding:.65rem .75rem;color:var(--color-text);background:var(--color-canvas);border:1px solid var(--color-border)}
.ip .search-controller button{min-height:48px;padding:.65rem 1rem;color:var(--color-on-primary);background:var(--color-primary);border:1px solid var(--color-primary);font-weight:800}
.ip .search-controller :is(input,button):focus-visible{outline:3px solid var(--focus-ring);outline-offset:2px}
.ip .search-controller button:disabled{cursor:wait;opacity:.58}
.ip .search-controller #site-search-status{margin:.65rem 0;color:var(--color-text-muted);font-size:.85rem}
.ip .search-controller #site-search-status[role="alert"]{color:var(--color-danger);font-weight:750}
.ip .search-controller :is(.search-results,.search-fallback ul){display:grid;gap:.5rem;margin:.75rem 0 0;padding:0;list-style:none}
.ip .search-controller .search-results article{min-width:0;padding:.75rem;overflow-wrap:anywhere;border:1px solid var(--color-border);border-left:3px solid var(--color-primary);background:var(--color-surface)}
.ip .search-controller .search-results h3{margin:.1rem 0;font-size:1rem}
.ip .search-controller .search-results p{margin:.35rem 0}
...
@media (min-width:44rem){.ip-menu{display:none}.ip-nav-wide{display:block;flex:1 1 60rem}.ip-directory{grid-template-columns:repeat(3,minmax(0,1fr))}.ip-list>ul,.ip-list>ol{grid-template-columns:repeat(2,minmax(0,1fr))}}
...
@media print{
  ...
  .ip-masthead,.ip-footer,.ip-skip,.ip-breadcrumbs,.ip .search-controller form,.ip aside[aria-label="광고"],.ip section[aria-labelledby="ip-reader-actions"],.ip nav[aria-label="목록 페이지 이동"],.ip button{display:none!important}
  ...
  .ip .search-controller .search-fallback ul{display:block}
  .ip .search-controller .search-fallback li{display:inline}
  .ip .search-controller .search-fallback li+li:before{content:" · "}
